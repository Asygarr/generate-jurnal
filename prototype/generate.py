...
def sesuaikan_dengan_template(dokumen_template, bagian):
    for para in dokumen_template.paragraphs:
        ...
        if "JUD1" in para.text:
            para.clear()
            print(bagian)
            # print(type(bagian))  # Check the type of `bagian`
            # print(bagian)        # Check the value of `bagian`
            ...
            para.clear()
            penulis = bagian.get('Nama Penulis', 'Nama Tidak Ditemukan')
...
path_skripsi = "prototype/data/skripsi_2.docx"
